...
# Load data directly from Kaggle mirror
@st.cache_data
def load_data():
    orders = pd.read_csv('https://raw.githubusercontent.com/pdevashree2/ecommerce-analysis/main/olist_orders_dataset.csv')
    customers = pd.read_csv('https://raw.githubusercontent.com/pdevashree2/ecommerce-analysis/main/olist_customers_dataset.csv')
    payments = pd.read_csv('https://raw.githubusercontent.com/pdevashree2/ecommerce-analysis/main/olist_order_payments_dataset.csv')
    order_items = pd.read_csv('https://raw.githubusercontent.com/pdevashree2/ecommerce-analysis/main/olist_order_items_dataset.csv')
    return orders, customers, payments, order_items

orders, customers, payments, order_items = load_data()
